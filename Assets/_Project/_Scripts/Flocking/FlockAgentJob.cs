...
public abstract class FlockAgentJob : MonoBehaviour
{

    BoidFlockJob _agentFlock;
    public float orbitBias;
    public BoidFlockJob AgentFlock { get { return _agentFlock; } }
    ...
    public void Initialize(BoidFlockJob flock)
    {
        _agentFlock = flock;
    }
